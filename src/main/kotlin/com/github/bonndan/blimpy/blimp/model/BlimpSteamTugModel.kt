...
class BlimpSteamTugModel(root: ModelPart) : EntityModel<BlimpRenderState>(root.getChild("bone")) {

    companion object {

        val LAYER_LOCATION = ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(BlimpyMod.MOD_ID, "blimp_model"),
            "main"
        )
